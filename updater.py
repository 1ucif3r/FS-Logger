...
def main():
    try:
        version = urlopen("https://raw.githubusercontent.com/F-Society-Official/FS-Logger/main/version.txt").read()
...
if __name__ == '__main__':
    ...
    print("\t\tAuthor: 1ucif3r | Github: github.com/1ucif3r\n")
    print("\t\tF-S0c13ty: github.com/F-Society-Official")
    print("[*] Welcome to FS-Logger's Auto Updater")
    print("[++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++]")
    print("[*] Please Note : Git must be installed in order to use \"updater.py\"")
    time.sleep(5)
    print("[++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++]")
    print("[*] Checking FS-Logger's version information..")
    print(main())
    print("[*] Exiting ...")
